...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 5px; font-size: 12px; color: var(--wf-gray); flex-wrap: wrap; opacity: 0.9;">
  <div style="display: flex; align-items: center; gap: 5px;">
    ...
    <a href="/updates_wiki/updateswiki" style="color: var(--wf-orange); text-decoration: none;">Updates</a>
    <span style="color: var(--wf-orange);">/</span>
    <span style="color: #e0e0e0;">Contribute</span>
  </div>
...
<div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 15px; border-top: 1px solid rgba(255,69,0,0.2); padding-top: 15px; margin-top: 5px;">
  ...
  <div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
    ...
    <PageTagBlue style="font-size: 11px; padding: 2px 8px;">updates</PageTagBlue>
    <PageTagOrange style="font-size: 11px; padding: 2px 8px;">contribute</PageTagOrange>
    <PageTagGreen style="font-size: 11px; padding: 2px 8px;">help</PageTagGreen>
  </div>
